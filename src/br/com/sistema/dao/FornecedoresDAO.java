...
public class FornecedoresDAO {
    ...
    public void Salvar(Fornecedores obj){
        try {
            ...
            stmt.close();
            JOptionPane.showMessageDialog(null, "O fornecedor foi salvo com sucesso.");
        } catch (SQLException erro) {
            JOptionPane.showMessageDialog(null,"Houve um erro ao salvar o fornecedor"+ erro);
        }
    }
    ...
    public void Editar(Fornecedores obj){
        try {
            ...
            // Terminar a conexão SQL
            stmt.close();
            JOptionPane.showMessageDialog(null, "O fornecedor foi editado com sucesso.");
        } catch (SQLException erro) {
            JOptionPane.showMessageDialog(null,"Houve um erro ao editar fornecedor"+ erro);
        }
    }
    ...
    public void Excluir(Fornecedores obj){
        try {
            ...
            stmt.execute();
            stmt.close();
            JOptionPane.showMessageDialog(null, "O fornecedor foi excluído com sucesso");
        } catch (SQLException e) {
          JOptionPane.showMessageDialog(null, "Houve um erro ao tentar excluir o fornecedor"+ e);
        }
    }
    ...
    public Fornecedores BuscarFornecedor(String nome){
        try {
            ...
            JOptionPane.showMessageDialog(null, "Houve um erro ao tentar encontrar o fornecedor" + erro);
        }
        return null;
    }
